        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="" method="POST">
                    ...
                    <div class="row mb-3">
                        <input type="hidden" value="<?php echo $data_opciones->getIdOpciones(); ?>" name="id_opciones" />

                        <label class="col-sm-2 col-form-table">Descripcion:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="opcion_descripcion" value="<?php echo $data_opciones->getOpcionDescripcion();?>" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" name="m" value="editarOpciones">
                        </div>
                    </div>
                </form>
            </div>
