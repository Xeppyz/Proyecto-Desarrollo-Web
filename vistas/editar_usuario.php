                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nombre"
                                   value="<?php echo $data_usuario->getNombres(); ?>"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="apellido" class="form-control"
                                   value="<?php echo $data_usuario->getApellidos(); ?>"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" name="email" class="form-control"
                                   value="<?php echo $data_usuario->getEmail(); ?>"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="usuario" class="form-control"
                                   value="<?php echo $data_usuario->getUsuario(); ?>"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="pwd" class="form-control"
                                   value="<?php echo $data_usuario->getPwd(); ?>"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
