...
$data_rol = $dtr->mostrarRol($varId_rol);
            ...
            <div class="col-lg-12">
                <form action="" method="POST">
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-2 col-form-table">Descripcion de Rol:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="desc" value="<?php echo $data_rol->getRolDesc();?>" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
