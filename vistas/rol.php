        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="agregar_rol.php">
                    <button type="button" class="btn btn-outline-primary">Agregar Roles</button>
                </a>
            </div>
...
<script>
    ...
    let dataTable = new DataTable(".rolesTable", {
        searchable: true,
        fixedHeight: true
    });
</script>
