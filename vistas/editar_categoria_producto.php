...
if(isset($varId_categoria_producto))
{
    $varId_categoria_producto = $_GET['id_categoria_producto'];
}

$data_categoria_producto = $dtcp->mostrarCategoriaProducto($varId_categoria_producto);
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="" method="POST">
                    <div class="row mb-3">
                        <input type="hidden" value="<?php echo $data_categoria_producto->getIdCategoriaProducto(); ?>" name="id_categoria_producto" />

                        <label class="col-sm-2 col-form-table">Nombre:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nombre" value="<?php echo $data_categoria_producto->getNombre();?>" />
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="descripcion" class="form-control" value="<?php echo $data_categoria_producto->getDescripcion(); ?>" />
                        </div>
